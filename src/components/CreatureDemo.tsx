...
export default function CreatureDemo() {
  ...
  useEffect(() => {
    ...
    const initialize = async () => {
      ...
      const bodyShape = createDolphinBodyShape();
      addShapePart(createDolphinTailShape(), finMaterial, 88);
      addShapePart(createDolphinDorsalFinShape(), finMaterial, 89);
      addShapePart(bodyShape, bodyMaterial, 90);
      addShapePart(createDolphinBellyShape(), bellyMaterial, 91);
      addShapePart(createDolphinPectoralFinShape(), finMaterial, 92);
